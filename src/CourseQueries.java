...
public class CourseQueries {
    ...
    public static ArrayList<CourseEntry> getAllCourses(String semester)
    {
        ...
        try
        {
            ...
            {
                CourseEntry currCourse = new CourseEntry(resultSet.getString(1), resultSet.getString(2), resultSet.getString(3), resultSet.getInt(4));
    ...
    public static ArrayList<String> getAllCourseCodes(String semester)
    {
        ...
        try
        {
            getAllCourses = connection.prepareStatement("select coursecode from app.course where semester = ?");
            getAllCourses.setString(1, semester);
            resultSet = getAllCourses.executeQuery();
    ...
    public static int getCourseSeats(String semester, String courseCode)
    {
        ...
        try
        {
            getAllCourses = connection.prepareStatement("select seats from app.course where semester = ? and courseCode = ?");
            getAllCourses.setString(1, semester);
            getAllCourses.setString(2, courseCode);
            resultSet = getAllCourses.executeQuery();
